...
authors:
  - drw
featureImage: /images/pexels-cottonbro-5053987.jpg
---
The *[Internet Search Engine Services Online Safety Code](https://www.esafety.gov.au/sites/default/files/2023-09/Schedule-6-Internet-Search-Engine-Services-Online-Safety-Code-Class-1A-and-Class-1B-Material.pdf)* is another tranche of policy that bars young people accessing ‘harmful content’, this time through search engines. It is unlikely to succeed in its stated ambition of protecting children, and will definitely cause harmful side-effects.
...
Age verification systems fail to meaningfully restrict young people's access to harmful content, instead pushing them to use VPNs or [unsafe alternatives](https://cepa.org/article/access-denied-the-uk-online-safety-act-misses-its-mark/).

[Age-verification does not reduce the consumption of pornography by young people](https://www.sbs.com.au/news/article/an-expert-warns-age-verification-for-porn-doesnt-work/nt3qltrwi). Instead, it creates [significant risks to individual privacy](https://humanrights.gov.au/about-us/media-centre/opinion-pieces/rights-and-freedoms/keeping-kids-safe-shouldnt-mean-a-loss-of-privacy-for-everyone), increases the likelihood of [data exploitation](https://theconversation.com/online-age-checking-is-creating-a-treasure-trove-of-data-for-hackers-268586), and harms young people. While regulators have identified [multiple methods for verification](https://www.infrastructure.gov.au/department/media/publications/age-assurance-technology-trial-final-report), each has critical flaws that either compromise privacy, allow easy circumvention, or both.

The UK's Online Safety Act is failing in real-time: widespread mockery, [VPN usage up 6,430%](https://ia.acs.org.au/article/2025/vpns-won-t-save-teens-from-social-media-ban.html#:~:text=Indeed%2C%20after%20the%20UK%20implemented,teens%20connecting%20via%20a%20VPN.), and [half a million people petitioning for repeal](https://yougov.co.uk/topics/society/survey-results/daily/2025/07/31/91334/3). Age-gating simply doesn't work. Australia won't be the first success story.
